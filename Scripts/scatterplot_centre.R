...
Centre <- mutate_if(Centre, is.character, stringr::str_replace_all, pattern = "Pre", replacement = "1")
Centre <- mutate_if(Centre, is.character, stringr::str_replace_all, pattern = "Peak", replacement = "2")
Centre$Period <- as.factor(Centre$Period)

#calculate ellipses
elli_Period <- dataEllipse(Centre$Experiment_Date, Centre$Water_Content, Centre$Period, group.labels=Centre$Period,
...
### DF by WC
df.wc <- ggplot(Centre, aes(Experiment_Date,Water_Content))+
  geom_point() +
  theme_classic() +  
...
#### DF by Ass
elli2_Period <- dataEllipse(Centre$Experiment_Date, Centre$Assimilation, Centre$Period, group.labels=Centre$Period,
                            weights, log="", levels=0.95, center.pch=19, 
...
df.ass <- ggplot(Centre, aes(Experiment_Date,Assimilation))+
  geom_point() +
  theme_classic() +  
...
#### DF by gs
elli3_Period <- dataEllipse(Centre$Experiment_Date, Centre$Stomatal_Conductance, Centre$Period, group.labels=Centre$Period,
                            weights, log="", levels=0.95, center.pch=19, 
                            center.cex=1.5, draw=FALSE, segments=51, 
...
df.gs <- ggplot(Centre, aes(Experiment_Date,Stomatal_Conductance))+
  geom_point() +
  theme_classic() +  
...
#### DF by SLA
elli4_Period <- dataEllipse(Centre$Experiment_Date, Centre$SLA, Centre$Period, group.labels=Centre$Period,
                            weights, log="", levels=0.95, center.pch=19, 
                            center.cex=1.5, draw=FALSE, segments=51, 
...
df.sla <- ggplot(Centre, aes(Experiment_Date,SLA))+
  geom_point() +
  theme_classic() +  
...
#### WC by Ass
elli5_Period <- dataEllipse(Centre$Water_Content, Centre$Assimilation, Centre$Period, group.labels=Centre$Period,
                            weights, log="", levels=0.95, center.pch=19, 
                            center.cex=1.5, draw=FALSE, segments=51, 
...
wc.ass <- ggplot(Centre, aes(Water_Content,Assimilation))+
  geom_point() +
  theme_classic() +  
...
#### WC by gs
elli6_Period <- dataEllipse(Centre$Water_Content, Centre$Stomatal_Conductance, Centre$Period, group.labels=Centre$Period,
                            weights, log="", levels=0.95, center.pch=19, 
                            center.cex=1.5, draw=FALSE, segments=51, 
...
wc.gs <- ggplot(Centre, aes(Water_Content,Stomatal_Conductance))+
  geom_point() +
  theme_classic() +  
...
#### WC by SLA
elli7_Period <- dataEllipse(Centre$Water_Content, Centre$SLA, Centre$Period, group.labels=Centre$Period,
                            weights, log="", levels=0.95, center.pch=19, 
                            center.cex=1.5, draw=FALSE, segments=51, 
...
wc.sla <- ggplot(Centre, aes(Water_Content,SLA))+
  geom_point() +
  theme_classic() +  
...
#### SLA by Ass
elli8_Period <- dataEllipse(Centre$SLA, Centre$Assimilation, Centre$Period, group.labels=Centre$Period,
                            weights, log="", levels=0.95, center.pch=19, 
                            center.cex=1.5, draw=FALSE, segments=51, 
...
sla.ass <- ggplot(Centre, aes(SLA,Assimilation))+
  geom_point() +
  theme_classic() +  
...
#### gs by sla
elli9_Period <- dataEllipse(Centre$Stomatal_Conductance, Centre$SLA, Centre$Period, group.labels=Centre$Period,
                            weights, log="", levels=0.95, center.pch=19, 
                            center.cex=1.5, draw=FALSE, segments=51, 
...
gs.sla <- ggplot(Centre, aes(Stomatal_Conductance,SLA))+
  geom_point() +
  theme_classic() +  
...
### gs by ASS
elli10_Period <- dataEllipse(Centre$Stomatal_Conductance, Centre$Assimilation, Centre$Period, group.labels=Centre$Period,
                             weights, log="", levels=0.95, center.pch=19, 
                             center.cex=1.5, draw=FALSE, segments=51, 
                             robust=FALSE, xlab="Stomatal Conductance", ylab="SLA", 
                             lwd=2, fill=FALSE, fill.alpha=0.3, grid=TRUE, id=FALSE) 
...
gs.ass <- ggplot(Centre, aes(Stomatal_Conductance,Assimilation))+
  geom_point() +
  theme_classic() +  
